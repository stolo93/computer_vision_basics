...
def main():
    ...
    for c in cnts:
        ...
        for x, y in box:
            cv2.circle(orig, (int(x), int(y)), 5, (0, 0, 255), cv2.FILLED)
        ...
        cv2.circle(orig, (tltr_x, tltr_y), 5, (255, 0, 0), cv2.FILLED)
        cv2.circle(orig, (blbr_x, blbr_y), 5, (255, 0, 0), cv2.FILLED)
        cv2.circle(orig, (tlbl_x, tlbl_y), 5, (255, 0, 0), cv2.FILLED)
        cv2.circle(orig, (trbr_x, trbr_y), 5, (255, 0, 0), cv2.FILLED)
